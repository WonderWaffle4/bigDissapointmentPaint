...
//        canvas[x][y] = symbol;
//        intLine(canvas, itc_len(canvas[0]), canvas.size(), x1, y1, x, y, symbol);
//    intLine(canvas, itc_len(canvas[0]), canvas.size(), x, y, x, 2 * y0 - y, symbol);
//    intLine(canvas, itc_len(canvas[0]), canvas.size(), x, y, x0 * 2 - x, y, symbol);
//    intLine(canvas, itc_len(canvas[0]), canvas.size(), x0 * 2 - x, y, x0 * 2 - x, 2 * y0 - y, symbol);
//    intLine(canvas, itc_len(canvas[0]), canvas.size(), x, 2 * y0 - y, x0 * 2 - x, 2 * y0 - y, symbol);
...
//    SetPixelSymmetry14C(canvas, x, y, x0, y0, radius, symbol);//bottom left
//
//    SetPixelSymmetry14C(canvas, x0 * 2 - x, 2 * y0 - y, x0, y0, radius, symbol);//up left
//
//    SetPixelSymmetry14C(canvas, x, 2 * y0 - y, x0, y0, radius, symbol);//bottom right
//
